...
clc
%% Initilization
th_int=[ (0 + pi/2) (0)]; %initial positions [th1 th2 th1_dot th2_dot th1_ddot th2_ddot]
ths=[(pi/2 - pi/2) (pi/4) 0 0 0 0]; %set-points [th1 th2 th1_dot th2_dot th1_ddot th2_ddot]
...
[T,X] = ode45(@(t,x) finger_2R(t,x,ths,spec,Kpid),Ts,x0);
%% Output
