...
pos = [0 pi/4 .1]; %m theta coordinate [inital final x initial position]
...
[lp,fval,exitflag] = lp_dynamics_sliding(mass,accel(:,i),alpha,R(:,i),mu,obj_lin_acc(1,i),svaj_curves(3,i),I);
x{i} = lp;
exitflag
end
torque_plot(tp,x);