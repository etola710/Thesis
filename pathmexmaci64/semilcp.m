function [z,mu] = semilcp(M,q,l,u,z,A,b,t,mu)
% semilcp(M,q,l,u,z,A,b,t,mu)
%
% Solve the standard linear complementarity problem using SEMI:
%     z >= 0, Mz + q >= 0, z'*(Mz + q) = 0
%
% Required input:
%     M(n,n)  - matrix
...
[status, ttime] = lcpsemi(n+m, nnzJ, z, l, u, M, q);
